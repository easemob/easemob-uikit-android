...
class EaseContactCheckActivity:EaseBaseActivity<EaseActivityContactAddLayoutBinding>(),
    ...
    companion object {
        ...
        fun createIntent(
            context: Context,
            userProfile: EaseProfile
        ): Intent {
            val intent = Intent(context, EaseContactCheckActivity::class.java)
            intent.putExtra(KEY_USER_PROFILE, userProfile.toUser())
