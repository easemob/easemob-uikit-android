...
enum class ChatUIKitMessageViewType(val value: Int) {
    ...
    VIEW_TYPE_MESSAGE_MARKDOWN_ME(24),
    VIEW_TYPE_MESSAGE_MARKDOWN_OTHER(25),
    VIEW_TYPE_MESSAGE_ALERT(60),
    VIEW_TYPE_MESSAGE_UNKNOWN_ME(98),
    VIEW_TYPE_MESSAGE_UNKNOWN_OTHER(99);

    companion object {
        fun from(value: Int): ChatUIKitMessageViewType {
            val types = values()
