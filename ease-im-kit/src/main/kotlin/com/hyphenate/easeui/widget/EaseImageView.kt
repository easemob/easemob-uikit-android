 ...
 */
class EaseImageView : AppCompatImageView {
    ...
    private fun init(context: Context, attrs: AttributeSet?) {
        ...
        if (attrs != null) {
            val array = context.obtainStyledAttributes(attrs, R.styleable.EaseImageView)
            ...
            borderWidth = array.getDimensionPixelOffset(
                R.styleable.EaseImageView_ease_border_width,
                borderWidth
            )
