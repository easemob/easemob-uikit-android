...
interface IChatViewRequest: IAttachView {
     ...
     * @param isThread
     */
    fun setupWithToUser(toChatUsername: String?, chatType: EaseChatType?, isThread: Boolean)
     ...
     * @param isCheck
     */
    fun sendMessage(message: ChatMessage?, isCheck: Boolean)

    /**
     * Resend message
     * @param message
     */
    fun resendMessage(message: EaseMessage?)
     ...
     * @param message
     */
    fun deleteMessage(message: EaseMessage?)
     ...
     * @param message
     */
    fun recallMessage(message: EaseMessage?)
     ...
     * @param reaction
     */
    fun addReaction(message: EaseMessage?, reaction: String?)
     ...
     * @param reaction
     */
    fun removeReaction(message: EaseMessage?, reaction: String?)
