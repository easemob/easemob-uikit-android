...
fun ChatGroup.getOwnerInfo(groupId:String):EaseUser{
   val syncMemberProfile = EaseIM.getGroupMemberProfileProvider()?.getSyncMemberProfile(groupId, owner)
   return syncMemberProfile?.toUser() ?: EaseUser(owner)
}
