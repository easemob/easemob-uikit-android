...
internal class EaseIMClientImpl: EaseIMClient {
    ...
    private var conversationInfoProvider: EaseConversationInfoProvider? = null
    private var userProvider: EaseUserProfileProvider? = null
    private var emojiconProvider: EaseEmojiconInfoProvider? = null
    private var groupMemberProvider: EaseGroupMemberProfileProvider? = null
    ...
    override fun login(userId: String, password: String, onSuccess: OnSuccess, onError: OnError) {
        ...
        ChatClient.getInstance().login(userId, password, CallbackImpl(onSuccess, onError))
    }
    ...
    override fun getCurrentUser(): EaseProfile? {
        return user ?:
        if (!ChatClient.getInstance().currentUser.isNullOrEmpty()) {
    ...
    override fun setConversationInfoProvider(provider: EaseConversationInfoProvider) {
        conversationInfoProvider = provider
    }
    ...
    override fun updateProfiles(profiles: List<EaseProfile>) {
    ...
    override fun setGroupMemberProfileProvider(provider: EaseGroupMemberProfileProvider) {
        groupMemberProvider = provider
    }

    override fun updateGroupMemberProfiles(groupId: String, profiles: List<EaseProfile>) {
        cache.updateGroupMemberProfiles(groupId, profiles)
    }
    ...
    override fun getConversationInfoProvider(): EaseConversationInfoProvider? {
    ...
    override fun getGroupMemberProfileProvider(): EaseGroupMemberProfileProvider? {
